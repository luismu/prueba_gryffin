        ...
        <script>
            $(document).on('ready', function(){
               ...
               $('#select-permisos').multiSelect({
                   ...
                   afterSelect:function(value){//enviando al servidor la id del permiso seleccionado
                        $.ajax({
                   ...
                   afterDeselect:function(value){//enviando al servidor la id del permiso seleccionado
                        $.ajax({
        ...
        <table class="table table-bordered table-hover">
            ...
            @if(isset($roles))
                ...
                @foreach($roles as $rol)
                    <tr><td>{{ $rol->name }}</td>
                        <td><a data-toggle="modal" rol_id="{{ $rol->id }}" data-target="#permisos" class="btn btn-primary get-permisos">Asignar Permisos</a></td>
